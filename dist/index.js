...
export const RequestResponseEmitterPlugin = async (instance, opts) => {
    instance.decorate("requestResponseEmitter", createTypedEventEmitter());
    if (opts.requestHeaderFilterFn) {
        instance.requestResponseEmitter.setRequestHeaderFilter(opts.requestHeaderFilterFn);
    }
    if (opts.responseHeaderFilterFn) {
        instance.requestResponseEmitter.setResponseHeaderFilter(opts.responseHeaderFilterFn);
    }
    ...
    instance.addHook("preValidation", (request, reply, done) => {
        instance.requestResponseEmitter.emit("onRequest", {
            ...
            headers: request.headers == null
                ? null
                : JSON.stringify(instance.requestResponseEmitter.filterRequestHeaders(request.headers)),
    ...
    instance.addHook("onResponse", (request, reply, done) => {
        instance.requestResponseEmitter.emit("onResponse", {
            ...
            headers: reply.headers == null
                ? null
                : JSON.stringify(instance.requestResponseEmitter.filterResponseHeaders(reply.getHeaders())),
            body: reply.requestResponseConfig.payload == null
                ? null
